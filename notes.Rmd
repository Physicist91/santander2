...
table(dat_train$TARGET[dat_train$saldo_var1 == 0]) #type2: unknown
table(dat_train$TARGET[dat_train$saldo_var5 < 0]) #type 1
table(dat_train$TARGET[dat_train$saldo_var8 < 0]) #type 1
table(dat_train$TARGET[dat_train$saldo_var12 > 0]) #type 2
table(dat_train$TARGET[dat_train$saldo_var13 == 0]) #type 2
table(dat_train$TARGET[dat_train$saldo_var14 > 0]) #type 2
table(dat_train$TARGET[dat_train$saldo_var17 > 0]) #type 2
table(dat_train$TARGET[dat_train$saldo_var18 == 0]) #type 2
table(dat_train$TARGET[dat_train$saldo_var20 == 0]) #type 2
table(dat_train$TARGET[dat_train$saldo_var24 == 0]) #type 2
table(dat_train$TARGET[dat_train$saldo_var26 == 0]) #type 2
table(dat_train$TARGET[dat_train$saldo_var25 > 0]) #type 2
```
...
This prevents overfitting somehow, but perhaps it's because this is removing very sparse variables.
